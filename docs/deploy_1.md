...
**Step1**: Create VM [Link](./setup_vm.md)
...
**Step6**: Set up Nginx as reverse proxy [Link](./setup_nginx.md)
...
**Step8**: Set up k3s [Link](./setup_k3s.md)

**Step9**: Set up Redis for job queue [Link](./setup_redis.md)
